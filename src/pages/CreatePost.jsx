   ...
   <div>
    ...
    <form className='mt-16 max-w-3xl ' onSubmit={handleSubmit}>
      <div className='flex flex-col gap-5 '>
        ...
        type="text"
        name="prompt"
        placeholder="Joa sunlit indoor lounge area with a pool with clear water and another pool with translucent pastel pink water, next to a big window, digital arthn Doe"
        value={form.prompt}
        handleChange={handleChange}
        isSurpriseMe
